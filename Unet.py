...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.e11 = nn.Conv2d(1, 64, kernel_size=3, padding=0) # output: 98x98x64
        ...
        # input: 48x48x64
        self.e21 = nn.Conv2d(64, 128, kernel_size=3, padding='same') # output: 48x48x128
        self.e22 = nn.Conv2d(128, 128, kernel_size=3, padding='same') # output: 48x48x128
        self.pool2 = nn.MaxPool2d(kernel_size=2, stride=2) # output: 24x24x128

        # input: 24x24x128
        self.e31 = nn.Conv2d(128, 256, kernel_size=3, padding='same') # output: 24x24x256
        self.e32 = nn.Conv2d(256, 256, kernel_size=3, padding='same') # output: 24x24x256
        self.pool3 = nn.MaxPool2d(kernel_size=2, stride=2) # output: 12x12x256

        # input: 12x12x256
        self.e41 = nn.Conv2d(256, 512, kernel_size=3, padding='same') # output: 12x12x512
        self.e42 = nn.Conv2d(512, 512, kernel_size=3, padding='same') # output: 12x12x512
